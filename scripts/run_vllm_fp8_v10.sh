#!/usr/bin/env bash
# Serve v10 (trajectory-aware, ViT unfrozen) FP8 model via vLLM 0.19.1.
set -euo pipefail
CHECKPOINT_TAG="${1:-c300}"
MODEL_DIR=/mnt/transit/soccer-finetune/checkpoints/v10-32b/fp8-${CHECKPOINT_TAG}
...
# HARD PIN: 0.20.0+ silently breaks Qwen3-VL-32B-FP8.
