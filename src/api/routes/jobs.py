...
class SubmitJobRequest(BaseModel):
    ...
    tag_only: bool = False
    # Per-job ball_crop override. Omit (None) to follow env-var default.
    ...
    # Per-job v9b ball-presence verifier override. Omit (None) to follow env-var.
...
def submit_job(request: SubmitJobRequest):
    ...
    job = create_job(video_file, request.reel_types, store, match_config,
                     ...
                     ball_presence_verifier_enabled=request.ball_presence_verifier_enabled)
